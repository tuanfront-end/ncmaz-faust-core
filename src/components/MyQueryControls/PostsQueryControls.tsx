...
// interface Props {
// 	className?: string;
// 	queriesControl: PostsQueryData;
// 	setAttrs__queries: (data: PostsQueryData) => void;
// }

// export const POSTS_QUERIES_DEMO_DATA: PostsQueryData = {
// 	postType: "post",
...
// const PostsQueryControls: FC<Props> = ({
// 	queriesControl = POSTS_QUERIES_DEMO_DATA,
// 	setAttrs__queries,
// 	className,
// }) => {
// 	const {
...
// export default PostsQueryControls;
