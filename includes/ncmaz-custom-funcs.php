...
if (!function_exists('ncmazGetOptionForSectionTrendingArchivePage')) :
...
if (!function_exists('ncmazFe_getCurrentUserGraphql')) :
...
if (!function_exists('ncmazFe_getAllSettingsGraphql')) :
...
// ============ GET LINK BY SLUG 
if (!function_exists('ncmazFe_getLinkBySlug')) :
...
// ============ GET ID BY SLUG
if (!function_exists('ncmazFe_getIDBySlug')) :
...
// ===
if (!function_exists('ncmazFe_checkEnableCountViewFeature')) :
...
if (!function_exists('ncmazFe_hex2rgba')) :
