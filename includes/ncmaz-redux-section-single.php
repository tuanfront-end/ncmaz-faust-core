    ...
    'fields'     => [
        ...
        [
            ...
            'data'  => array(
                ...
                '2'         => 'Style 2',
                '3'         => 'Style 3',
                '1_required'         => 'Style 1 - Overwrite (Apply to all posts, overwrite the "Single page style" custom field in post)',
                '2_required'         => 'Style 2 - Overwrite (Apply to all posts, overwrite the "Single page style" custom field in post)',
                '3_required'         => 'Style 3 - Overwrite (Apply to all posts, overwrite the "Single page style" custom field in post)',
            ),
            'default' => '1'
        ],
        [
