        ...
        acf_add_local_field_group(array(
            ...
            'fields' => array(
                array(
                    ...
                    'show_in_graphql' => 1,
                    'choices' => array(
                        'by_theme_options' => 'Default by theme options',
                        1 => 'Style 1',
                        2 => 'Style 2',
                        3 => 'Style 3',
                    ),
                ...
                array(
                    ...
                    'type' => 'true_false',
                    'instructions' => 'Show right sidebar on single post page.',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '',
                ...
                array(
                    ...
                    'aria-label' => '',
                    'type' => 'text',
                    'instructions' => 'Count the number of views of this post.',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '49%',
                ...
                array(
                    'key' => 'field_64bc6592c15f7',
                    'label' => 'Saved list',
                    'name' => 'saved_list',
                    'aria-label' => '',
                    'type' => 'text',
                    'instructions' => 'List the users (id of logged in user and IP address of not logged in) who saved this post.',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '',
                ...
                array(
                    'key' => 'field_64bc69071efe9',
                    'label' => 'Reaction liked list',
                    'name' => 'reaction_liked_list',
                    'aria-label' => '',
                    'type' => 'text',
                    'instructions' => 'List the users (id of logged in user and IP address of not logged in) who liked this post.',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '',
