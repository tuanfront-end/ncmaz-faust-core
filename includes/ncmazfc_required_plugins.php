...
function ncmazfc__theme_register_required_plugins()
{
	 ...
	 */
	$config = array(
		'id'           => 'ncmaz-faust-core',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'dismiss_msg'  => 'Please install and activate the required plugins for the Ncmaz Faust Core plugin to function correctly.',                      // If 'dismissable' is false, this message will be output at top of nag.
		'is_automatic' => false,                   // Automatically activate plugins after installation or not.
		'message'      => 'Please install and activate the required plugins for the Ncmaz-faust-core plugin to function correctly.',                      // Message to output right before the plugins table.
